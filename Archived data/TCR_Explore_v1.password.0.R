...
#   sqlite_path = "SQdb/database.sqlite", # will be created
...
ui <- navbarPage("TCR_Explore", position = "fixed-top",collapsible = TRUE,
                 ...
                 tabPanel("scTCR analysis",
                          sidebarLayout(
                            sidebarPanel(id = "tPanel",style = "overflow-y:scroll; max-height: 700px; position:relative;", width=3,
                                         ...
                                         actionButton("update.scTCR","update plots"),
                 ...
                 # UI bar graphs ----- 
                              tabPanel("Chain bar graph",
                                       ...
                                       fluidRow(
                                         ...
                                         column(2,style = "margin-top: 10px;", textInput("colour_bar.usage","Colour of bars", value = "black"))
                 ...
                 # UI CDR3 length distribution graphs ----- 
                              tabPanel("CDR3 length distribution",
                                       ...
                                       fluidRow(
                                         column(4, numericInput("bin","Bins of histogram",value=30)),
                 ...
                 tabPanel("FACS Index data",
                          sidebarLayout(
                            sidebarPanel(id = "tPanel3",style = "overflow-y:scroll; max-height: 800px; position:relative;", width=3,
                                         actionButton("update.FACS","Press to update columns"),
                            ...
                            mainPanel(tabsetPanel(
                 # checking FACS file was uploaded -----
                 ...
                 # UI complex dotplot -----
                                tabPanel("Complex dotplot",
                                         fluidRow(
                                           column(3,selectInput("x.axis2",label = h5("Select x-axis"),"")),
                                           column(3,selectInput("y.axis2",label = h5("Select y-axis"),"")),
                                         ...
                                         fluidRow(
                                           ...
                                           column(3, selectInput("legend.dot",label=h5("Legend location"),choices = c("top","bottom","left","right","none"),selected = "right")),
...
server  <- function(input, output, session) {
 ...
 df <- as.data.frame("please complete QC analysis")
  ...
  observeEvent( input$update.QC,{
    updateSelectInput(
      session,
      "string.data3",
      choices=names(chain_merge_IMGTonly()),
...
#   # scTCR data ------
  ...
  observeEvent(input$update.scTCR, {
    updateSelectInput(
      session,
      "group_column",
...
#    df3 <- as.data.frame(merge(both,unique.col,by.x="V1",by.y = "V1"))
  ...
  observeEvent(input$update.FACS,{
    updateSelectInput(
      session,
      "V.gene.1",
