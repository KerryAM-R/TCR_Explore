...
ui <- navbarPage("TCR_explore", position = "fixed-top",collapsible = TRUE,
                 ...
                 tabPanel("QC",
                          ...
                          imageOutput("myImage2",inline = T),
                          p(" "),
                          p(" "),
                          imageOutput("myImage3",inline = T),
                          p(" "),
                          p(" "),
                          imageOutput("myImage4",inline = T),
                          p(" "),
                          p(" "),
                          imageOutput("myImage5",inline = T),
                          p(" "),
                          p(" "),
                          imageOutput("myImage6",inline = T),
                 ),
...
server  <- function(input, output, session) {
  ...
  output$myImage <- renderImage({
    ...
    filename <- normalizePath(system.file("extdata","Logo.png",package = "TCR.Explore"))
  ...
  output$myImage2 <- renderImage({
    # Generate the PNG
    # When input$n is 3, filename is ./images/image3.jpeg
    filename <- normalizePath(system.file("extdata","Slide1.png",package = "TCR.Explore"))
    # Return a list containing the filename and alt text
    list(src = filename,
         height = "600")
  ...
  output$myImage3 <- renderImage({
    # Generate the PNG
    # When input$n is 3, filename is ./images/image3.jpeg
    filename <- normalizePath(system.file("extdata","Slide2.png",package = "TCR.Explore"))
    # Return a list containing the filename and alt text
    list(src = filename,
         height = "600")
  ...
  output$myImage4 <- renderImage({
    # Generate the PNG
    # When input$n is 3, filename is ./images/image3.jpeg
    filename <- normalizePath(system.file("extdata","Slide3.png",package = "TCR.Explore"))
    # Return a list containing the filename and alt text
    list(src = filename,
         height = "600")
  ...
  output$myImage5 <- renderImage({
    # Generate the PNG
    # When input$n is 3, filename is ./images/image3.jpeg
    filename <- normalizePath(system.file("extdata","Slide4.png",package = "TCR.Explore"))
    # Return a list containing the filename and alt text
    list(src = filename,
         height = "600")
  ...
  output$myImage6 <- renderImage({
    # Generate the PNG
    # When input$n is 3, filename is ./images/image3.jpeg
    filename <- normalizePath(system.file("extdata","Slide5.png",package = "TCR.Explore"))
    # Return a list containing the filename and alt text
    list(src = filename,
         height = "600")
  ...
  test.data_ab.xls <- reactive({
    dataframe = read_excel(system.file("extdata","T00016.xls",package = "TCR.Explore")) 
  })
  ...
  test.data_ab.xls3 <- reactive({
    dataframe = read_excel(system.file("extdata","vquest-2.xls",package = "TCR.Explore")) 
  })
  ...
  test.data_ab.xls4 <- reactive({
    dataframe = read_xls(system.file("extdata","vquest-2.xls",package = "TCR.Explore"),sheet = 2) 
  })
 ...
 df <- as.data.frame("please complete QC analysis")
  ...
  test.data2 <- reactive({
  dataframe = read.csv(system.file("extdata","paired_unsummarised2021.09.22.csv",package = "TCR.Explore"),header=T) 
  })
  own.data2 <- reactive({
    inFile2 <- input$file2 
  ...
  dataframe = read.csv(system.file("extdata","diversity.csv",package = "TCR.Explore"),header=T)   
  })
...
#    df3 <- as.data.frame(merge(both,unique.col,by.x="V1",by.y = "V1"))
  ...
  test.data_FACS <- reactive({
    read.FCS(system.file("extdata","Specimen_001_INX_PBMCs 4905 CBZ sort IFN 1_014.fcs",package = "TCR.Explore"))
  })
  ...
  test.data.gd.index.csv2 <- reactive({
    dataframe = read.csv(system.file("extdata","4905_VD1_paired_ex_vivo1.csv",package = "TCR.Explore"),header=T,row.names = 1) 
  })
  ...
  test.data_csv1 <- reactive({
    ...
    dataframe = read.csv(system.file("extdata","4905.csv",package = "TCR.Explore"),header = T,row.names = 1)
  })
  ...
  test.data_csv2<- reactive({
    ...
    dataframe = read.csv(system.file("extdata","colouring column2021.09.08.csv",package = "TCR.Explore"),header = T)
  })
